...
\midinsert
\clabel[5_yet_to_do]{Sample of the initial dataset}
\picw=5cm \cinspic figures/temp_structure_of_edges_geojson_file.jpg
\caption/f Sample of the structure of initial dataset. IMAGE IS TEMPORARY.
\endinsert
