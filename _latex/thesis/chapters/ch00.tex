...
& \vrule\hskip2pt \vtop{\hsize=.2\hsize\noindent\strut #\strut \hfil} \tabskip=1em \crcr 
% data
Dataset & \# of valid segments & \# of images \cr
  \noalign{\hrule}
Original "5556x_markable_640x640" & a & b \cr
min length 10m "5556x_minlen10_640px" & a & b \cr
min length 20m "5556x_minlen20_640px" & a & b \cr
min length 30m "5556x_minlen30_640px" & a & b \cr
}
\hrule
}
\vskip5pt
...
\picw=13cm \cinspic graphs/6.1.2._splitting_long_edges-minlen/fig3_2x2comparison.pdf
\caption/f Overall illustration of the training process of three datasets which were enhanced by long edge splitting and an original dataset for reference.
\endinsert

\midinsert
\clabel[36_splitedge_valerr]{Split long edges, validation error over iterations}
\picw=13cm \cinspic graphs/6.1.2._splitting_long_edges-minlen/fig2_average_valerr.pdf
\caption/f For better clarity we present only the averages of validation errors over the 10 runs of k-fold cross-validation with k=10.
\endinsert

\midinsert
\clabel[36_splitedge_boxplot]{Split long edges, comparison of last epoch between datasets}
\picw=13cm \cinspic graphs/6.1.2._splitting_long_edges-minlen/fig1_boxplot_last.pdf
\caption/f Comparison of the results of splitting long edges into smaller segments. The smaller the minimal edge length was, the more images were generated. Dataset "5556x_markable_640x640" under the label original was used for comparison.
\endinsert
...
Dataset & \# of images \cr
  \noalign{\hrule}
Original "5556x_markable_640x640" & a \cr
Expanded & a \cr
Aggresively expanded & a \cr
  \noalign{\hrule}
Original "5556x_minlen30_640px" & a \cr
Expanded & a \cr
Aggresively expanded & a \cr
}
\hrule
...
\line{\hsize=.5\hsize \vtop{%
      ...
      \picw=4.2cm \cinspic graphs/6.1.3._augmentation-original,expanded,agg_expanded/figLeft_.pdf
      %\caption/f Last epoch validation error
   \par}\vtop{%
      %\clabel[37_augmentation_evol]{Dataset augmentation evolution over epochs}
      \picw=9cm \cinspic graphs/6.1.3._augmentation-original,expanded,agg_expanded/figRight_.pdf
      %\caption/f Evolution over epochs
   \par}}
%\centerline {aaa\hfil\hfil bbb}\nobreak\medskip
\caption/f Comparison of the two augmented datasets with the original referential one. Expanded dataset used the transformations of image flipping and shifting. Aggressively expanded dataset used additional transformations of shear, scale and rotation.}
\endinsert
...
\picw=13cm \cinspic graphs/6.2.2._model_competition-img-vs-osm-vs-mix/fig1_evolution.pdf
\caption/f Model competition, evolution over epochs.
\endinsert

\midinsert
\line{\hsize=.5\hsize \vtop{%
      \clabel[38_modelversus_last]{Model competition, last epoch}
      \picw=6cm \cinspic graphs/6.2.2._model_competition-img-vs-osm-vs-mix/fig2_last_epoch.pdf
      \caption/f Model competition, last epoch
   \par}\vtop{%
      \clabel[38_modelversus_best]{Model competition, best epoch}
      \picw=6cm \cinspic graphs/6.2.2._model_competition-img-vs-osm-vs-mix/fig3_best_epoch.pdf
      \caption/f Model competition, best epoch
   \par}}
%\centerline {aaa\hfil\hfil bbb}\nobreak\medskip
\endinsert
