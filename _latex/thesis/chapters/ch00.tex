...
Throughout the whole run of experiments, we keep a shared Setting structure in form of python dictionary. Each experiment we run first loads default settings values and then is altered depending on the experiment description file. This allows us to reuse a lot of code and also prevents us from human error in terms of typos.
